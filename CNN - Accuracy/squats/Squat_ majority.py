...
weights_path = r'C:\Users\mosac\Git Repositories\FitnessAI\CNN - Accuracy\squats\model_weights.pickle'
...
# Example usage
folder_path = r'C:\Users\mosac\Git Repositories\FitnessAI/models/data/Flexing OR Stretching'
#folder_path = '/Users/rotemcohen/FitnessAI/models/data/for_test'
folder_status = determine_folder_status(folder_path)
print(f"The folder is {folder_status}.")
